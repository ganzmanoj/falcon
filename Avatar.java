...
{  
   Picture1 pic1 = new Picture1(new ImageIcon("pics/1.png").getImage());
   Picture2 pic2 = new Picture2(new ImageIcon("pics/2.png").getImage());
   Picture3 pic3 = new Picture3(new ImageIcon("pics/3.png").getImage());
   Picture4 pic4 = new Picture4(new ImageIcon("pics/4.png").getImage());
   Picture5 pic5 = new Picture5(new ImageIcon("pics/5.png").getImage());
   
   JButton jb1,jb2,jb3,jb4,jb5;
   static String ava1="pics/1.png";
